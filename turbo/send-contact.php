...
<?php
	...
	$siteName = 'Turboinsta';
	$nameMessage = isset($name) ? $name : 'Получить консультацию';
			...
			$amo = new \AmoCRM\Client($subdomain, $login, $apikey);
				...
				if(count($contacts) == 0 ){
					...
					$lead->addCustomField(305117, [ // ID  поля в которое будт приходить заявки
							[$name], // сюда вписать значение из атрибута "name" пример: <input name="phone">
					]);
					$id = $lead->apiAdd();
					$contact = $amo->contact;
					// Заполнение полей модели
					$contact['name'] = $nameMessage;
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
											<h1 class="offer__title">Привлекаем аудиторию для Вашего Instagram аккаунта <br>в большом количестве!</h1>
                        <!-- /.main-title -->
                ...
                <div class="step-one__advantages">
                        ...
                        <div class="col-xl-auto col-lg-auto col-md-auto">
                            ...
                            <!-- /.step-one__video -->
										...
										<div class="row d-flex flex-column justify-content-center">
											...
											<!-- /.h2 -->
											<a  class="nazad"href="https://turboinsta.com.ua" style="text-decoration: none; border-bottom: 1px dotted; text-align: center" >Вернуться назад</a>
										</div>
										<!-- /.row -->
                </div>
								<!-- /.step-one__advantages -->
                    ...
                    <div class="step-two__sale_action">
                        <img src="img/step-two/15.svg" alt="" class="lazy">
                        <p>
                    ...
                    <!-- /.step-two__sale_action -->
                    <div class="step-two__sale_action">
                        <img src="img/step-two/20.svg" alt="" class="lazy">
                        <p>
